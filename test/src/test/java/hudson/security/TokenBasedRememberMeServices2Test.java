...
public class TokenBasedRememberMeServices2Test {
    ...
    public void rememberMeToken_shouldNotAccept_expirationDurationLargerThanConfigured() throws Exception {
        ...
        extractedMethod58546(username, tokenService, alice);
    }
    ...
    private void extractedMethod58546(final String username, final TokenBasedRememberMeServices2 tokenService, final User alice) throws Exception {
