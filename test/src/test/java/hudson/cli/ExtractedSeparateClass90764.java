...
public final class ExtractedSeparateClass90764 {
    private ExtractedSeparateClass90764() {
        throw new UnsupportedOperationException("This class cannot be instantiated");
    }
    
    public static void extractedMethod92556(final OneShotEvent finish, final Future<FreeStyleBuild> build, final JenkinsRule j, final FreeStyleProject project) throws Exception {
        finish.signal();
        build.get();
