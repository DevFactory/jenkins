...
/*
   ...
   Autogenerated by CAP duplicate fixer v1.1.0 at 13-05-2021 05:05:27.

   Locations of Issue Instances ( File, [StartLine:StartColumn ~ EndLine:EndColumn] ):

   test/src/test/java/hudson/cli/OfflineNodeCommandTest.java , [328:9~353:109]
   test/src/test/java/hudson/cli/DisconnectNodeCommandTest.java , [190:9~215:109]
...
public final class ExtractedSeparateClass31112 {
    private ExtractedSeparateClass31112() {
        throw new UnsupportedOperationException("This class cannot be instantiated");
    }
    
    public static void extractedMethod47983(final JenkinsRule j, final CLICommandInvoker command) throws Exception {
