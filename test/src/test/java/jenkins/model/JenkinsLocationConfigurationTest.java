...
public class JenkinsLocationConfigurationTest {
    ...
    public void cannotInjectJavaScriptUsingRootUrl_inNewViewLinkAction() throws Exception {
        ...
        // last verification
        extractedMethod96652(alertAppeared, newViewLink); // CAP AL
    }
    ...
    public void cannotInjectJavaScriptUsingRootUrl_inLabelAbsoluteLink() throws Exception {
        ...
        extractedMethod96652(alertAppeared, labelAnchor); // CAP AL
 ...
 // CAP AL
    private void extractedMethod96652(final AtomicReference<Boolean> alertAppeared, final HtmlAnchor newViewLink) throws IOException { // CAP AL
